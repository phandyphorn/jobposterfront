    ...
    <div class="examples">
        ...
        <div>
            <div class="example">
                ...
                <div class="demo">
                    <google-pay-button environment="TEST" v-bind:button-type="buttonType"
            ...
            <div class="example">
                ...
                <div class="demo">
                    <google-pay-button environment="TEST" v-bind:button-type="buttonType"
                        ...
                        }" v-on:loadpaymentdata="onLoadPaymentData" v-on:error="onError"
                        v-bind:onPaymentAuthorized.prop="onPaymentDataAuthorized"></google-pay-button>
                </div>
            </div>
            <div class="example">
                ...
                <div class="demo">
                    <google-pay-button environment="TEST" v-bind:button-type="buttonType"
                        ...
                        v-bind:paymentRequest.prop="{
                            ...
                            callbackIntents: ['PAYMENT_AUTHORIZATION'],
                        }" v-on:loadpaymentdata="onLoadPaymentData" v-on:error="onError" v-on:readytopaychange="onReadyToPayChange"
                        v-bind:onPaymentAuthorized.prop="onPaymentDataAuthorized"></google-pay-button>
                </div>
            </div>
            <div class="example">
                ...
                <div class="demo">
                    <google-pay-button environment="TEST" v-bind:button-type="buttonType"
                        ...
                        }" v-on:loadpaymentdata="onLoadPaymentData" v-on:error="onError" v-bind:clickCallback.prop="onClick">
                    </google-pay-button>
                    <google-pay-button environment="TEST" v-bind:button-type="buttonType"
                        v-bind:button-color="buttonColor"
                        v-bind:existing-payment-method-required="existingPaymentMethodRequired"
                        ...
                        v-bind:clickCallback.prop="onClickPreventDefault"></google-pay-button>
                </div>
            </div>
        </div>
    </div>
